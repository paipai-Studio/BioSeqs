...
│   └── ... （更多 examples/*_demo/）
├── test/
│   ├── moonbit/                      # MoonBit 单元测试（539 个测试文件，13736 用例）
...
```bash
moon build      # 构建项目
moon test       # 运行全部测试 (13736 个测试用例，test/moonbit 包)
```
